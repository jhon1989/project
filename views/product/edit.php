    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role='form' method="POST" action="index.php?page=product" class="form-edit">
              ...
              <div class="form-group col-sm-12">
                ...
                <input type='number' min="1" class="form-control" placeholder="Stock Minimo" name="st_min" id="st_min" required="required"/>
              </div>
              <div class="clearfix"></div>
              <div class="form-group col-sm-12">
            ...
            <div class="modal-footer">
                <button type="submit" value="edit" name="edit" class="btn btn-primary">Registrar Productos</button>
